...
<script type="text/javascript" src="${my_path}/static/src/wysiwyg.js"></script>

<script type="text/javascript" src="${my_path}/static/src/wysiwyg-editor.js"></script>

<link rel="stylesheet" href="http://www.jq22.com/jquery/font-awesome.4.6.0.css">

<link rel="stylesheet" type="text/css" href="${my_path}/static/src/wysiwyg-editor.css" />
...
$(document).ready(function(){
...

    {
        ...
        $(element).wysiwyg({
            ...
            position: pl2 == 0 ? 'top-selection' : (pl2 == 1 ? 'bottom' : 'selection'),

            buttons: {

                // Dummy-HTML-Plugin

                dummybutton1: pl2 != 1 ? false : {
                ...
                smilies: {
                    ...
                    popup: function( $popup, $button, $editor ) {
                            ...
                            var list_smilies = [
                                    ...
                                    '<img src="${my_path}/static/smiley/afraid.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/amorous.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/angel.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/angry.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/bored.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/cold.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/confused.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/cross.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/crying.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/devil.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/disappointed.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/dont-know.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/drool.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/embarrassed.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/excited.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/excruciating.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/eyeroll.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/happy.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/hot.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/hug-left.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/hug-right.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/hungry.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/invincible.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/kiss.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/lying.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/meeting.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/nerdy.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/neutral.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/party.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/pirate.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/pissed-off.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/question.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/sad.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/shame.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/shocked.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/shut-mouth.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/sick.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/silent.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/sleeping.png" width="16" height="16" alt="" />',

                                    '<img src="${my_path}/static/smiley/sleepy.png" width="16" height="16" alt="" />',
                    ...
                    showselection: pl2 == 2 ? true : false    // wanted on selection
                ...
                fontname: pl2 == 1 ? false : {
                    ...
                    showselection: pl2 == 0 ? true : false    // wanted on selection

                },

                fontsize: pl2 == 1 ? false : {
