...
import com.belong.model.TypeExample.Criteria;
import com.belong.model.TypeExample.Criterion;
...
public class TypeSqlProvider {
    ...
    public String insertSelective(Type record) {
        ...
        if (record.getTid() != null) {
            VALUES("Tid", "#{tid,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(TypeExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
